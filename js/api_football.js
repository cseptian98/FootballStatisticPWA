...
function showTeam(data) {
    ...
    teamHTML += `<img src=${data.crestUrl.replace(/^http:\/\//i, 'https://')} onError="this.onerror=null;this.src='/images/default.png';" width="180" height="180" class="responsive-img center"><br>
                  <h5>${data.name}</h5>
                  <center>
    ...
    dbData.then(data => {
        ...
        if (data.length > 0) {
            ...
            <div>
              ...
              <img src=${team.crestUrl.replace(/^http:\/\//i, 'https://')} alt="" class="responsive-img" width="220">
            </div>
            <br><br>`;
            });
        } else {
